...
module.exports = (io) => {
  io.on("connection", async (socket) => {
    ...
    socket.on("disconnect", function () {
      ...
      if (roomInfo) {
        roomInfo.colors.push(roomInfo.players[socket.id].team);
        roomInfo.unassignedRandomTasks.push(
          roomInfo.players[socket.id].randomTasks
        );
